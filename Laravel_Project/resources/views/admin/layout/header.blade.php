...
<div class="container-scroller d-flex">
        ...
        <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
          <div class="ps-lg-1">
            <div class="d-flex align-items-center justify-content-between">
              <p class="mb-0 font-weight-medium me-3 buy-now-text">Courier Managment System</p>
              <a href="{{asset('backend/https://wordpress-923989-3206731.cloudwaysapps.com/product/spica-admin/?utm_source=organic&amp;utm_medium=banner&amp;utm_campaign=buynow_demo')}}" target="_blank" class="btn me-2 buy-now-btn border-0">Get Pro</a>
            </div>
          </div>
          <div class="d-flex align-items-center justify-content-between">
            <a href="{{asset('backend/https://wordpress-923989-3206731.cloudwaysapps.com/product/spica-admin/')}}"><i class="mdi mdi-home me-3 text-white"></i></a>
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('agent/create')}}">
        ...
        <li class="nav-item">
          ...
          <!-- <div class="collapse" id="ui-basic"> -->
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url('agent/create')}}">Create Agent</a></li>
              <li class="nav-item"> <a class="nav-link" href="{{url('agent')}}">Manage Agent Details</a></li>
            </ul>
          <!-- </div> -->
        </li>
        <li class="nav-item">
          ...
          <!-- <div class="collapse" id="ui-basic"> -->
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url('courieragent/create')}}">Courier Details</a></li>
              <li class="nav-item"> <a class="nav-link" href="{{url('courieragent')}}">Courier Agent Details</a></li>
            </ul>
          <!-- </div> -->
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('statuscount')}}">
            <i class="mdi mdi-chart-pie menu-icon"></i>
            <span class="menu-title">Status Count</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          ...
          <!-- <div class="collapse" id="auth"> -->
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{url('lockscreen')}}"> Lockscreen </a></li>
              <li class="nav-item"> <a class="nav-link" href="{{url('shiping')}}"> DownLoad Shiping </a></li>
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{url('dashboard')}}"><img src="{{asset('backend/images/logo.png')}}" height="40px" width="40px" alt="logo"/></a>
